...
describe('user Model', function () {
    ...
    it('create method should add a new user ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.create(newuser)];
                case 1:
                    result = _a.sent();
                    ...
                    expect(bcrypt_1.default.compareSync(result.password + pepper, newuser.password))
                        .toBeTruthy;
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(bcrypt_1.default.compareSync(result[0].password + pepper, newuser.password))
                        .toBeTruthy;
                    return [2 /*return*/];
            }
        });
    }); });
    it('show method should return user with id==1', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
