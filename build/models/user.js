        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get users. Error: ".concat(err_1.message));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO users (email,firstname,lastname,password) VALUES($1, $2, $3, $4) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1.default.hashSync(usr.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [
                                usr.email,
                                usr.firstName,
                                usr.lastName,
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(usr.email, " . Error: ").concat(err_3.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
